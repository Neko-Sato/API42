...
async def main(pisciners:dict[int, str], passed:bool, output:TextIO, client_id:str=None, client_secret=None) -> int:
	...
	# res["rush_00"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.rush_00)

	# res["c_02"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_02)
	# res["c_03"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_03)
	# res["c_04"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_04)
	# res["c_05"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_05)
	# res["exam_01"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.exam_01)
	# res["rush_01"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.rush_01)
	
	# res["c_06"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_06)
	# res["c_07"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_07)
	# res["c_08"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_08)
	# res["c_09"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_09)
	# res["exam_02"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.exam_02)
	# res["rush_02"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.rush_02)

	# res["bsq"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.bsq)
	# res["c_10"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_10)
	# res["c_11"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_11)
	# res["c_12"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_12)
	# res["c_13"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.c_13)
	# res["final_exam"] = get_project_mark(api, credential, pisciners.keys(), PROJECTS_C_PISCINE.final_exam)
